            ...
            <div key={ingredientId} className="col-sm-10 offset-2">
              <div className="row mb-3">
                <div className="col-md-6">
                  <input type="text" name={"ingredient-name-" + i} className="form-control d-inline-block mr-2 mb-2" placeholder="Név" required />
                </div>
                <div className="col-md-2"> 
                  <input type="text" name={"ingredient-quantity-" + i} className="form-control d-inline-block mr-2 mb-2" placeholder="Mennyiség" required />
                </div>
                <div className="col-md-2"> 
                  <select defaultValue="" name={"ingredient-type-" + i} className="form-control d-inline-block mr-2 mb-2" required >
          ...
          {stepIds.map((stepId, i) => (
            <div key={stepId} className="col-sm-10 offset-2">
              <div className="row mb-3 border-bottom">
                <div className="col-md-6">
                  <input type="text" name={"step-content-" + i} className="form-control d-inline-block mr-2 mb-2" placeholder={i + 1 + ". lépés"} required />
                </div>
                <div className="col-md-2">
                  <input type="number" name={"step-timer-" + i} className="form-control d-inline-block mr-2 mb-2" placeholder="idő" min={1} required />
                </div>
                <div className="col-md-2">
                  <div className="w-100">
                    <button className="btn btn-danger mb-3" type="button"
                      onClick={() => {
                        setStepIds((prevIds) => {
                          const ret = [...prevIds];
                          ret.splice(
                            prevIds.findIndex((id) => id === stepId), 1
                          );
                          return ret;
                        });
                      }}
